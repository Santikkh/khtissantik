      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-blue-500/30 transition-all duration-500">
        ...
        <div className="space-y-6">
          ...
          <ContactCard
            ...
            title="Phone"
            value="+855 97 4334 852"
            link="tel:+855974334852"
          />
          <ContactCard
            icon={
              <svg
        ...
        <div className="mt-8 pt-8 border-t border-white/10">
          ...
          <div className="flex space-x-4">
            ...
            />
            <SocialLink
              href="https://www.linkedin.com/in/khtis-santik-18126b338/"
              icon={
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
