...
import profileImage from "../assets/santik.jpg";
...
const HeroV3 = () => {
  return (
    <section
      id="home"
      className="min-h-screen relative overflow-hidden bg-[#0A0A0A] pt-24 md:pt-0"
    >
      {/* Gradient Overlay */}
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-3 space-y-6 lg:space-y-8">
              ...
              >
                {["Facebook", "GitHub", "LinkedIn", "Twitter"].map(
                  (platform) => (
                    <a
                      key={platform}
                      href="#"
